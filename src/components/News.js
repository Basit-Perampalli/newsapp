    ...
    return (
      <div>
        ...
        <div className="container d-flex justify-content-between">
            <button disabled={this.state.page<=1} type="button" className="btn btn-dark mx-2"onClick={this.prevClick}> &larr; Previous</button>
            <button disabled={this.state.page>=Math.ceil(this.state.totalResults/15)} type="button" className="btn btn-dark mx-2" onClick={this.nextClick}>Next &rarr;</button>
        </div>
      </div>
    )
  }
